        ...
        if (this.state.alarmValue || values.description) {
          if (this.state.astatus === 0) {
            if (values.description && this.state.alarmValue === undefined) {
              ...
              this.state.alarmValue === 1 ||
              this.state.alarmValue === 3 ||
              values.description
            ) {
              const datas = {
              ...
              (this.state.alarmValue === 1 || this.state.alarmValue === 3) &&
              values.description
            ) {
              const datas = {
                handlememo: values.description,
            ...
            (this.state.alarmValue === 3 && this.state.astatus === 1) ||
            values.description
          ) {
            const datas = {
              handlememo: values.description,
            ...
            (this.state.alarmValue === 3 && this.state.astatus === 2) ||
            values.description
          ) {
            const datas = {
              handlememo: values.description,
    ...
    return (
      <div className="AlarmDetail">
        ...
        >
          ...
          <div
            className="handle reportinf"
            style={{
              display: this.state.astatus === 3 ? "none" : "inline-flex"
            }}
          >
