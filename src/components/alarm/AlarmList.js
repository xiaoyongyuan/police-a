  ...
  handleState = (state, atime, adminname, lastmemo, lastmen) => {
    if (state === 0) {
      return (
        <div className="dashed">
          <Row className="pol polone">
            <Col span={24}>
              <span className="powercolor Pushed">已推送</span>
            </Col>
          </Row>
      ...
      return (
        <div className="dashed">
          <Row className="pol polone">
            <Col span={24} className="AlarmReceiver">
              <span className="powercolor AlarmReceiver">接警人：</span>
              {adminname}
            </Col>
          </Row>
          <Row className="pol poltwo">
        ...
        <div className="dashed">
          <Row className="pol polone">
            <Col span={24} className="processing">
              <span className="powercolor processing">处理人：</span>
              {lastmen}
            </Col>
          </Row>
          <Row className="pol poltwo">
      ...
      return (
        <div className="dashed">
          <Row className="pol polone">
            <Col span={24}>
              <span className="powercolor CaseClosed">已结案</span>
            </Col>
          </Row>
          <Row className="pol poltwo">
            <Col span={24}>
